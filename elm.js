...
Elm.App.make = function (_elm) {
   ...
   var pageFooter = A2($Html.p,
   _L.fromArray([]),
   _L.fromArray([$Html.text("By Jack")]));
   var pageHeader = A2($Html.h2,
   _L.fromArray([]),
   _L.fromArray([$Html.text("Bingo")]));
   ...
   var entries = _L.fromArray([A3(newEntry,
                              "Context",
                              200,
                              1)
                              ,A3(newEntry,"Coffee",100,2)]);
   var initialModel = {_: {}
                      ,entries: entries};
